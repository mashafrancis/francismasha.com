...
Logstash requires Java to be installed as a pre-requisite. We will use the open-source distribution OpenJDK.
Use their documentation to run the command compatible to your Operating System. I am running Oracle Linux and will use the following command:
...
Configure the FortiGate Syslog server using the commands below. My Logstash server IP is 192.168.25.110:
