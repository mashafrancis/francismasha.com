  ...
  return (
    <footer className="max-w-screen overflow-x-hidden px-2">
      <div className="screen-line-before mx-auto border-x border-edge pt-4 md:max-w-3xl">
        <p className="mb-1 px-4 text-center font-sans text-sm text-balance text-muted-foreground">
          Inspired by tailwindcss.com + ui.shadcn.com + https://chanhdai.com
        </p>

        <p className="mb-4 px-4 text-center font-sans text-sm text-balance text-muted-foreground">
          Built by{" "}
          <a
            className="link"
        ...
        >
          <div className="mx-auto flex items-center justify-center gap-3 border-x border-edge bg-background px-4">
            <a
              className="flex font-sans text-xs font-medium text-muted-foreground"
