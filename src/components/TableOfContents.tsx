...
export default function TableOfContents({
	...
	console.log('Class: default, Function: TableOfContents, Line 32 isTOCActive():', isTOCActive);
	...
	return (
		<>
			{tableOfContents.length > 0 && (
				<>
					<div
						className={`fixed h-full print:hidden bg-darkWhite dark:bg-darkPrimary fixed z-50 flex h-screen w-full flex-col gap-1 overflow-y-scroll p-10 !pb-[100px] text-neutral-800 transition-all duration-500 dark:text-gray-200 md:left-0 md:max-w-[35%] md:p-14 md:opacity-100 lg:max-w-[30%]`}
					>
						<H3
							...
							{toc.map((content) => {
								return (
									<Link
										key={content.heading}
										href={content.url}
										className='hover:bg-gray-100 relative overflow-hidden rounded-tr-md rounded-br-md border-l-2 border-neutral-300 px-2 py-0.5 font-normal text-neutral-700 hover:text-gray-400 dark:text-neutral-200 dark:hover:border-white md:py-1 md:line-clamp-1'
