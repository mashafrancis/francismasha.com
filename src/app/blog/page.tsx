...
export default function BlogPage() {
	...
	return (
		<section className='fade-in divide-y divide-gray-200 dark:divide-gray-500'>
			<Header title={`All posts. (${displayPosts.length})`}>
							...
							>
								<article className='items-flex-start grid space-y-2 space-y-0 xl:grid-cols-6'>
									<div className='col-span-3 xl:col-span-6'>
										<h3 className='grid grid-cols-[auto_1fr_auto] items-center text-xl font-bold leading-8 tracking-tight md:text-2xl'>
											{title}
										</h3>
