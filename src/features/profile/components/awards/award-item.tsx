...
export function AwardItem({
  ...
  return (
    <Collapsible disabled={!canExpand} render={<div className={className} />}>
        ...
        <div className="flex-1 border-edge border-l border-dashed">
          <CollapsibleTrigger className="group/award flex w-full select-none items-center gap-4 p-4 pr-2 text-left">
            ...
            {canExpand && (
              ...
              >
                <ChevronsDownUpIcon className="hidden group-data-open/award:block" />
                <ChevronsUpDownIcon className="hidden group-data-closed/award:block" />
              </div>
            )}
          </CollapsibleTrigger>
        </div>
