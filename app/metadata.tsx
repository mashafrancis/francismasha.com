export default {
  ...
  openGraph: {
    ...
    description:
      'A software engineer who values learning and growing with people, teams, and technologies.',
    url: 'https://francismasha.com',
    siteName: 'Francis Masha',
    images: [
      {
        url: 'https://francismasha.com/og.png',
        width: 1920,
        height: 1080,
      },
    ],
  ...
  analytics: {
    ...
    plausibleDataDomain: 'francismasha.com', // e.g. tailwind-nextjs-starter-blog.vercel.app
