...
| Nodes | Current threads in use, and maximum number. |
| Count of Active Shards | Counts and total time spent with garbage collection. |
| Relocating Shards | Usage statistics for heap and non-heap processes and pools. |
| Initializing Shards | Current threads in use, and maximum number. |
| Unassigned Shards | Counts and total time spent with garbage collection. |
| | |
